...
int main()
{
    ...
    double linkLengthT2 {0.130};
    double linkLengthT3 {0.135};
    double linkLengthT4 {0.126};

    // twist angle for t1...t4
    double twistAngleT1 {90};
    double twistAngleT2 {0};
    double twistAngleT3 {0};
    double twistAngleT4 {0};

    //joint offset for t1...t4
    double jointOffsetT1 {0.077};
    double jointOffsetT2 {0};
    double jointOffsetT3 {0};
    double jointOffsetT4 {0};

    //joint angle for t1...t4
    double jointAngleT1 {103};
    double jointAngleT2 {15};
    double jointAngleT3 {-5};
    double jointAngleT4 {21};
